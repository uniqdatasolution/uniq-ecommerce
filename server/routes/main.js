...
router.route('/categories')
  ...
  .post([checkJWT], (req, res, next) => {
    console.log('==================req.partama', req, req.params, req.body)
    const id = req.params.id;
    if(req.body && req.body.product_picture && req.body.product_picture != {}) {
      console.log('==========================img', req.body.product_picture)
      req.image = req.protocol + '://' + req.get('host')+'/' + req.file.name;
    }
    ...
    // Product.findByIdAndUpdate({ _id: req.params.id }, (err, product) => {
    //   if (err) return next(err);
    ...
    //   // product.image = req.protocol + '://' + req.get('host')+'/' + req.file.path;
    //   // product.isSeller = req.body.isSeller;
